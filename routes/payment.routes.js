...
const { checkStock, formatLineItems } = require("../utils/checkoutHelpers");
...
router.post("/checkout", (req, res, next) => {
  ...
  Product.find({ reference: { $in: referencesArray } })
    .then((productList) => {
      ...
      checkStock(productList, productsToCheckout);
     
      const lineItems = formatLineItems(productList, productsToCheckout);
